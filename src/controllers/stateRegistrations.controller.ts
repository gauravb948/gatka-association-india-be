...
export async function create(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    > = {
      ...
      associationOfficeAddress: body.associationOfficeAddress,
      associationOfficialContactNumber: body.associationOfficialContactNumber,
      associationRegisterNumber: body.associationRegisterNumber,
      passportPhotoUrl: body.passportPhotoUrl ?? null,
      addressProofUrl: body.addressProofUrl ?? null,
      associationCertificateUrl: body.associationCertificateUrl ?? null,
      associationOfficeAddressProofUrl: body.associationOfficeAddressProofUrl ?? null,
      associationDeclarationUrl: body.associationDeclarationUrl ?? null,
    ...
    if (existing) {
      ...
      await applyZeroFeeSubmissionIfPending(userIdOut, Role.STATE_ADMIN);
      const submittedReg = (await stateRegistrationRepo.findByStateId(body.stateId)) ?? reg;
